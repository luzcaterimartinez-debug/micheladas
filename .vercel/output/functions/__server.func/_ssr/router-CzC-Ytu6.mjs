...
import { C as CloudOff, S as ServerCrash, a as CloudUpload, L as LoaderCircle, W as Wifi } from "../_libs/lucide-react.mjs";
...
function mapComanda(raw) {
  ...
  return {
    ...
    metodoPago: raw.metodoPago != null ? raw.metodoPago : void 0,
    montoPagado: raw.montoPagado != null ? Number(raw.montoPagado) : void 0,
    propina: Number(raw.propina ?? 0),
    pagoEfectivo: raw.pagoEfectivo != null ? Number(raw.pagoEfectivo) : void 0,
    pagoTarjeta: raw.pagoTarjeta != null ? Number(raw.pagoTarjeta) : void 0,
    pagoTransferencia: raw.pagoTransferencia != null ? Number(raw.pagoTransferencia) : void 0,
    pagadoEn: raw.pagadoEn != null ? Number(raw.pagadoEn) : void 0,
    cobradoPorId: raw.cobradoPorId != null ? Number(raw.cobradoPorId) : void 0
  };
}
...
function useOfflineSync() {
  ...
  const [serverReachable, setServerReachable] = reactExports.useState(true);
  ...
  const pingServer = reactExports.useCallback(async () => {
  ...
  reactExports.useEffect(() => {
    ...
    refresh();
    void pingServer();
    const interval = window.setInterval(() => void pingServer(), 15e3);
    return () => {
      teardown();
...
const PUBLIC_ROUTES = /* @__PURE__ */ new Set(["/login", "/carta"]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-lg flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 min-w-0", children: offline ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CloudOff, { className: "h-4 w-4 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Sin internet — los cambios se guardan localmente" })
        ] }) : serverDown ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ServerCrash, { className: "h-4 w-4 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Servidor no disponible — revisa la API o intenta más tarde" })
        ...
        online && serverReachable && pending > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
...
const appCss = "/assets/styles-1rshMY9Z.css";
...
const $$splitComponentImporter$5 = () => import("./login-B8GSHV-3.mjs");
...
const $$splitComponentImporter$4 = () => import("./impresion-D9bGD0CK.mjs");
...
const $$splitComponentImporter$3 = () => import("./carta-CMnH45eS.mjs");
...
const $$splitComponentImporter$2 = () => import("./barra-t1mmxol8.mjs");
...
const $$splitComponentImporter$1 = () => import("./admin-wQhfGmN3.mjs");
...
const $$splitComponentImporter = () => import("./index-Dv0XOzIo.mjs");
...
export {
  ...
  calcItemTotal as J,
  Route$1 as K,
  getPendingCount as L,
  Route as M,
  MICHELADAS as N,
  fetchMenu as O,
  flattenProductos as P,
  router as Q,
  Route$4 as R,
  clearSession as a,
  getApiUrl as b,
