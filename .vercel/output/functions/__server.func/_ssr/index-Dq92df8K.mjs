...
import { P as PosHeader, T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DuW7t0ST.mjs";
import { M as MichelandiaBackground, T as Toaster, c as MeseroStepHeader, a as ThemedPanel, b as ThemedPanelHeader, d as MenuPriceRow, e as MichelandiaFooterBar, F as FlavorGridCard } from "./sonner-D7NcLsQE.mjs";
...
import { L as Route, H as ROL_LABELS, a as clearSession, u as useComandas, f as useInventory, j as useMesas, E as getStoredSession, I as calcItemTotal, c as cn, K as getPendingCount, i as isAppOnline } from "./router-BGt08YE6.mjs";
import { I as InventoryPanel, i as isFasePaso, p as parseFaseIdFromPaso, o as opcionesForFase, T as Textarea, n as normalizeProductPasos, P as PASO_NOTAS, f as fasePasoId, j as buildOrderDeductions } from "./inventory-deduction-7IuSmXE1.mjs";
import { d as ComandaViewDialog, B as Badge } from "./badge-CuQWouht.mjs";
...
import { M as MenuProvider, u as useMenu, f as faseOpcionNames, o as orderItemSubtitle } from "./menu-context-Clk78U5N.mjs";
import { q as Boxes, n as ClipboardList, r as Users, h as Beer, L as LoaderCircle, A as ArrowLeft, I as ArrowRight, t as Plus, J as Bell, f as Check, K as Armchair, N as ShoppingBag, O as MapPin, u as Pencil, Q as User, S as ShoppingCart, G as ChevronUp, F as ChevronDown, w as Trash2 } from "../_libs/lucide-react.mjs";
...
function MeseroOrderWizard() {
  ...
  async function sendOrder() {
    ...
    try {
      ...
      toast.success(
        queued ? `Turno ${c.queueOrder} · Comanda #${c.folio} guardada localmente. Se sincronizará al volver la red.` : `Turno ${c.queueOrder} · Comanda #${c.folio} enviada. Se imprime en barra automáticamente.`
      );
      void reloadMesas();
      setCart([]);
      setCliente("");
